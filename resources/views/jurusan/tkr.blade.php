...
<div class="ekskul-detail-page is-visible">
  ...
  <div class="jurusan-hero" style="--jurusan-accent:#D6493B;">
    ...
    <div class="jurusan-hero-content">
      <div class="jurusan-hero-badge">TKR</div>
      <h1 class="jurusan-hero-title">{{ $jurusan->nama_jurusan }}</h1>
      <p class="jurusan-hero-subtitle">Kompetensi Keahlian · Teknik Kendaraan Ringan</p>
    </div>
    ...
    <div class="guru-section">
      ...
      <div class="guru-lead">
        <div class="guru-lead-photo" data-name="{{ $jurusan->kepala_jurusan }}" data-subject="Kepala Jurusan">
          <img src="{{ asset('storage/images/guru-guru/'.$jurusan->foto_kepala_jurusan) }}" alt="{{ $jurusan->kepala_jurusan }}">
        </div>

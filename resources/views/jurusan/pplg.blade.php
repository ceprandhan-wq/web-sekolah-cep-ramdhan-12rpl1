...
<div class="ekskul-detail-page is-visible">
  ...
  <div class="jurusan-hero" style="--jurusan-accent:#2FB6A8;">
    ...
    <div class="jurusan-hero-content">
      <div class="jurusan-hero-badge">PPLG</div>
      <h1 class="jurusan-hero-title">{{ $jurusan->nama_jurusan }}</h1>
      <p class="jurusan-hero-subtitle">Kompetensi Keahlian · Rekayasa Perangkat Lunak</p>
    </div>

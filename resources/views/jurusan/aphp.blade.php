...
<div class="ekskul-detail-page is-visible">
  ...
  <div class="jurusan-hero" style="--jurusan-accent:#6FA85B;">
    ...
    <div class="jurusan-hero-content">
      <div class="jurusan-hero-badge">APHP</div>
      <h1 class="jurusan-hero-title">{{ $jurusan->nama_jurusan }}</h1>
      <p class="jurusan-hero-subtitle">Kompetensi Keahlian · Agrobisnis Pengolahan Hasil Pertanian</p>
    </div>
